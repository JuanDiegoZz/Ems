...
export function LogoutButton() {
  ...
  async function logout() { setBusy(true); clearRecentPeople(); clearActiveShift(); try { await fetch("/api/auth/logout", { method: "POST" }); } finally { router.replace("/login"); router.refresh(); } }
