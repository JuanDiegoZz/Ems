...
export function mobileMoreItems(role: AppRole): MobileNavItem[] { return [{ href: "/history", label: "Historial", icon: "history" }, { href: "/profile", label: "Perfil", icon: "user" }, ...(role === "admin" ? [{ href: "/admin/users", label: "Personal EMS", icon: "shield" as IconName }, { href: "/admin/ems-performance", label: "Rendimiento EMS", icon: "activity" as IconName }, { href: "/admin/settings", label: "Configuración", icon: "settings" as IconName }] : [])]; }
