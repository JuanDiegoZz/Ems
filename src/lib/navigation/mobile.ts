...
export function mobileMoreItems(role: AppRole): MobileNavItem[] { return [{ href: "/history", label: "Historial", icon: "history" }, { href: "/profile", label: "Perfil", icon: "user" }, { href: "/prices", label: "Precios", icon: "tags" }, ...(role === "admin" ? [{ href: "/admin/staff", label: "Personal EMS", icon: "shield" as IconName }, { href: "/admin/analytics", label: "Analíticas", icon: "analytics" as IconName }, { href: "/admin/bonuses", label: "Bonos semanales", icon: "badgeDollarSign" as IconName }, { href: "/admin/ems-performance", label: "Rendimiento EMS", icon: "activity" as IconName }, { href: "/admin/settings", label: "Configuración", icon: "settings" as IconName }] : [])]; }
